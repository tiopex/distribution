...
makeinstall_target() {
  mkdir -p ${INSTALL}/usr/share/bootloader/rocknix_abl
    cp ${PKG_BUILD}/abl_signed-SM8550.elf ${INSTALL}/usr/share/bootloader/rocknix_abl/abl_signed-${DEVICE}.elf
    cp ${PKG_BUILD}/abl_signed-SM8550.elf ${INSTALL}/usr/share/bootloader/rocknix_abl/abl_signed-SM8550.elf
